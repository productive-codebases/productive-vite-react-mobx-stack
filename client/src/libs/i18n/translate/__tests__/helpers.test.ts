import { translate as trans } from '..'
import { interpolate, plural, transformMarkdown } from '../helpers'
...
describe('i18n helpers', () => {
  ...
  describe('transformMarkdown()', () => {
    it('should transform markdown translations to HTML', () => {
      const test1 = transformMarkdown(
        interpolate(trans('en')('Tests')('Markdown')('X identities'), { X: 42 })
      )

      expect(test1).toBe('<p><strong>42</strong> identities</p>')
    })
  })
